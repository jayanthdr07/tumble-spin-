                ...
                {activeTab === 'pricing' && (
                  <div className="flex-1 overflow-y-auto p-6 bg-slate-50 dark:bg-brand-dark/20 min-h-0">
                    <div className="max-w-2xl mx-auto space-y-6 py-4">
                      ...
                      {/* Live Estimation Audit Card */}
                      <div className="p-5 bg-white dark:bg-brand-dark rounded-2xl border border-slate-100 dark:border-brand-teal/10 shadow-xs space-y-3">
                        <span className="text-[10px] font-bold text-brand-primary dark:text-brand-accent uppercase tracking-widest font-mono">
                          Live Dynamic Price Audit Preview
                        </span>
                        
                        <div className="p-4 rounded-xl bg-slate-50 dark:bg-brand-deep/30 border border-slate-100 dark:border-brand-teal/5 space-y-3">
                          <div className="flex items-center justify-between text-xs font-bold text-slate-400 font-mono pb-2 border-b border-slate-200/50 dark:border-brand-teal/5">
                          ...
                          {[
                            { name: 'Wash & Fold (per kg)', standard: 95 },
                            { name: 'Wash & Steam Iron (per kg)', standard: 129 },
                            { name: 'Saree Dry Clean (per pc)', standard: 230 },
                            { name: 'Men Suit 3-Pc (per pc)', standard: 530 }
                          ].map((item, idx) => {
                            let adjusted = item.standard;
                      ...
                      <div className="p-6 bg-white dark:bg-brand-dark rounded-2xl border border-slate-100 dark:border-brand-teal/10 shadow-xs space-y-5">
                        ...
                        {pricingMode !== 'none' && (
                          <>
                            {/* Percentage input */}
                            <div className="space-y-1.5">
                              <label className="block text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider flex justify-between">
                                <span>Adjustment Percentage</span>
                                <span className="text-brand-primary dark:text-brand-accent font-bold">{pricingPercentage}%</span>
                              </label>
                              <div className="flex items-center gap-4 bg-slate-50 dark:bg-brand-deep/20 p-3.5 rounded-xl border border-slate-100 dark:border-brand-teal/5">
                                <input
                                  type="range"
                                  min="5"
                                  max="40"
                                  ...
                                  onChange={(e) => setPricingPercentage(parseInt(e.target.value, 10))}
                                ...
                                />
                                <span className="text-xs font-bold font-mono text-slate-800 dark:text-white shrink-0 w-8 text-right">
                                  {pricingPercentage}%
                                </span>
                              </div>
                            </div>
                            ...
                            <div className="space-y-1.5">
                              <label className="block text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">
                                Custom Rate Tag Label (e.g., 'Peak Festive Surge' or 'Rainy Season Discount')
                              </label>
                              <input
                                type="text"
                                value={pricingLabel}
                                onChange={(e) => setPricingLabel(e.target.value)}
                                placeholder="Describe why rate adjustment is active..."
                                className="w-full rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-xs font-bold text-slate-800 dark:border-brand-teal/20 dark:bg-brand-deep/50 dark:text-white focus:outline-hidden focus:border-brand-primary"
                              />
                            </div>
                          </>
                        ...
                        <div className="pt-4 border-t border-slate-100 dark:border-brand-teal/5 flex items-center justify-end gap-3">
                          ...
                          <button
                            ...
                            className="px-5 py-2.5 rounded-full bg-brand-primary text-white dark:bg-brand-accent dark:text-brand-deep text-xs font-bold uppercase tracking-wider shadow-md hover:scale-[1.01] active:scale-[0.99] transition-all"
                          >
                            Publish Pricing Adjustment
                          </button>
                        </div>
                      </div>

                      {/* Manual Price Overrides Editor */}
                      <div className="p-6 bg-white dark:bg-brand-dark rounded-2xl border border-slate-100 dark:border-brand-teal/10 shadow-xs space-y-6">
                        <div className="space-y-1 pb-3 border-b border-slate-100 dark:border-brand-teal/5">
                          <h4 className="text-sm font-extrabold text-slate-800 dark:text-white font-mono uppercase tracking-wider">
                            🛠️ Manual Item & Service Price Overrides
                          </h4>
                          <p className="text-[11px] text-slate-400 dark:text-slate-500">
                            Change prices manually for standard services, garment estimator items, or booking services. Overrides persist permanently across all devices and updates instantly. Leave empty to restore defaults.
                          </p>
                        </div>

                        {priceSuccessMessage && (
                          <div className="p-4 rounded-xl text-xs font-bold font-sans bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border border-emerald-500/20">
                            {priceSuccessMessage}
                          </div>
                        )}

                        {/* Search & Tabs */}
                        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 bg-slate-50 dark:bg-brand-deep/10 p-3 rounded-2xl border border-slate-100 dark:border-brand-teal/5">
                            ...
                            {[
                              ...
                              <button
                                ...
                                className={`px-3 py-1.5 rounded-lg text-xs font-bold transition-all ${
                                  priceEditorTab === tab.id
                                    ? 'bg-brand-primary text-white dark:bg-brand-accent dark:text-brand-deep shadow-xs'
                                    : 'text-slate-500 hover:text-slate-700 dark:text-slate-400 dark:hover:text-white hover:bg-slate-100/50 dark:hover:bg-brand-deep/30'
                                }`}
                              >
                                {tab.label}
                              </button>
                          ...
                          <div className="relative">
                            ...
                            <input
                              type="text"
                              value={priceEditorSearch}
                              onChange={(e) => setPriceEditorSearch(e.target.value)}
                              placeholder="Search item/service..."
                              className="pl-8 pr-4 py-1.5 w-full sm:w-48 text-xs font-bold rounded-xl border border-slate-200 dark:border-brand-teal/10 bg-white dark:bg-brand-deep/30 text-slate-800 dark:text-white focus:outline-hidden"
                            />
                          </div>
                        </div>
                        ...
                        <div className="space-y-4 max-h-[50vh] overflow-y-auto pr-1">
                          {priceEditorTab === 'services' && (
                            <div className="grid gap-3">
                              {[
                                { id: 'wash-fold', name: 'Wash & Fold', unit: 'per kg', defaultPrice: 95 },
                                { id: 'wash-iron', name: 'Wash & Steam Iron', unit: 'per kg', defaultPrice: 129 },
                                { id: 'dry-cleaning', name: 'Dry Cleaning', unit: 'per item', defaultPrice: 199 },
                                { id: 'steam-iron', name: 'Steam Ironing', unit: 'per item', defaultPrice: 49 },
                                { id: 'express', name: 'Express Service (24h surcharge)', unit: 'flat rate', defaultPrice: 499 },
                                { id: 'premium-care', name: 'Premium Garment Care', unit: 'per item', defaultPrice: 399 },
                                ...
                                .map((service, idx) => {
                                  ...
                                  return (
                                    <div key={`editor-service-${service.id}-${idx}`} className="flex items-center justify-between p-3.5 rounded-xl border border-slate-100 dark:border-brand-teal/5 bg-slate-50/50 dark:bg-brand-deep/5 flex-col sm:flex-row gap-3">
                                      ...
                                      <div className="relative shrink-0 w-full sm:w-32 self-end">
                                        ...
                                        <input
                                          ...
                                          onChange={(e) => {
                                            ...
                                            setLocalPricesDraft((prev: any) => ({
                                              ...prev,
                                              services: {
                                                ...prev.services,
                                                [service.id]: v === '' ? null : Number(v)
                                              }
                                            }));
                                          }}
                                          className="w-full text-right pr-4 pl-7 py-1.5 text-xs font-black font-mono rounded-xl border border-slate-200 dark:border-brand-teal/15 bg-white dark:bg-brand-deep/50 text-slate-800 dark:text-white focus:outline-hidden focus:border-brand-primary"
                                        />
                                      </div>
                                    </div>
                                  );
                                    ...
                                    <div key={`editor-estimator-${item.id}-${idx}`} className="p-4 rounded-xl border border-slate-100 dark:border-brand-teal/5 bg-slate-50/50 dark:bg-brand-deep/5 space-y-3">
                                      ...
                                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                        {item.dryCleanPrice !== null && (
                                          <div className="space-y-1">
                                            <label className="block text-[10px] font-bold text-slate-400 uppercase tracking-wider">Dry Clean Price</label>
                                            <div className="relative">
                                              <span className="absolute left-3.5 top-2 text-xs font-mono font-bold text-slate-400">₹</span>
                                              <input
                                                type="number"
                                                placeholder={String(item.dryCleanPrice)}
                                                value={dryCleanDraft}
                                                onChange={(e) => {
                                                  const v = e.target.value;
                                                  setLocalPricesDraft((prev: any) => ({
                                                    ...
                                                    estimator: {
                                                      ...prev.estimator,
                                                      [item.id]: {
                                                        ...prev.estimator?.[item.id],
                                                        dryClean: v === '' ? null : Number(v)
                                                      }
                                                    }
                                                  }));
                                                }}
                                                className="w-full text-right pr-4 pl-7 py-1.5 text-xs font-black font-mono rounded-xl border border-slate-200 dark:border-brand-teal/15 bg-white dark:bg-brand-deep/50 text-slate-800 dark:text-white focus:outline-hidden"
                                              />
                                            </div>
                                            <p className="text-[9px] text-slate-400 font-mono">Default: ₹{item.dryCleanPrice}</p>
                                          </div>
                                        )}

                                        {item.steamIronPrice !== null && (
                                          <div className="space-y-1">
                                            <label className="block text-[10px] font-bold text-slate-400 uppercase tracking-wider">Steam Iron Price</label>
                                            <div className="relative">
                                              <span className="absolute left-3.5 top-2 text-xs font-mono font-bold text-slate-400">₹</span>
                                              <input
                                                type="number"
                                                placeholder={String(item.steamIronPrice)}
                                                value={steamIronDraft}
                                                onChange={(e) => {
                                                  const v = e.target.value;
                                                  setLocalPricesDraft((prev: any) => ({
                                                    ...prev,
                                            ...
                                            <p className="text-[9px] text-slate-400 font-mono">Default: ₹{item.steamIronPrice}</p>
                                          </div>
                                        )}
                                      </div>
                                    </div>
                        ...
                        {/* Actions */}
                        <div className="pt-4 border-t border-slate-100 dark:border-brand-teal/5 flex items-center justify-between flex-wrap gap-3">
                          <button
                            type="button"
                            onClick={() => {
                              if (window.confirm('Are you sure you want to delete all manual price overrides and restore default rates?')) {
                                ...
                                setLocalPricesDraft(emptyPrices);
                                setPriceSuccessMessage('All pricing overrides deleted. Systems reverted to standard rates.');
                                setTimeout(() => setPriceSuccessMessage(''), 4000);
                              }
                            }}
                            className="px-4 py-2 rounded-xl text-xs font-bold text-rose-500 hover:bg-rose-50 dark:hover:bg-rose-500/10 hover:text-rose-600 transition-all border border-transparent hover:border-rose-200"
                          >
                          ...
                          <div className="flex items-center gap-2">
                            <button
                              type="button"
                              onClick={() => {
                                setLocalPricesDraft(JSON.parse(JSON.stringify(customPrices)));
                                setPriceSuccessMessage('Draft changes discarded.');
                            ...
                            <button
                              ...
                              onClick={() => {
                                const sanitized = {
                                  services: { ...localPricesDraft?.services },
                                  estimator: { ...localPricesDraft?.estimator },
                                  booking: { ...localPricesDraft?.booking }
                                };
                                localStorage.setItem('tumblespin_custom_prices', JSON.stringify(sanitized));
                                setCustomPrices(sanitized);
                                setPriceSuccessMessage('Custom prices published successfully and synced across all staff devices!');
                                setTimeout(() => setPriceSuccessMessage(''), 4000);
                              }}
                              className="px-5 py-2.5 rounded-full bg-brand-primary text-white dark:bg-brand-accent dark:text-brand-deep text-xs font-bold uppercase tracking-wider shadow-md hover:scale-[1.01] active:scale-[0.99] transition-all"
                            >
                              Publish Custom Prices
                            </button>
                          </div>
                        </div>
                      </div>
